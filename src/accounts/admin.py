...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ['username', 'employee_id', 'first_name', 'last_name', 'role', 'branch', 'is_verified']
    list_filter = ['role', 'branch', 'is_verified', 'date_joined']
